...
@Component({
  selector: 'app-qrcode-scan-view',
  templateUrl: './qrcode-scan-view.component.html',
  styleUrls: ['./qrcode-scan-view.component.css']
})
export class QrcodeScanViewComponent implements OnInit {
